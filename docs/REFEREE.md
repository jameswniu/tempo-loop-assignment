...
```
Claim     "16 or 17 of 20 checks on each of eight consecutive runs, a median of 85%" (NOTES.md, the evaluation suite paragraph)
...
Command   npm run eval -- openai, roughly 25 seconds, and eight consecutive runs produced 16, 17, 16, 16, 17, 17, 17 and 17
...
```
Claim     "npm test runs 128 tests" (NOTES.md line 35)
